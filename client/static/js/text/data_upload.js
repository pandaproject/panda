PANDA.text.DataUpload = function() {
    return {
        ...
        upload_space_critical: gettext("Your PANDA has %(space)s available for files. You should contact your PANDA adminstrator about expanding the available storage space. <strong>Uploads may fail.</strong>"),
        upload_space_warning: gettext("Your PANDA has %(space)s available for files. You should contact your PANDA adminstrator about expanding the available storage space."),
        index_space_critical: gettext("Your PANDA has %(space)s available for search indices. You should contact your PANDA adminstrator about expanding the available storage space. <strong>Uploads may fail.</strong>"),
        index_space_warning: gettext("Your PANDA has %(space)s available for search indices. You should contact your PANDA adminstrator about expanding the available storage space."),
