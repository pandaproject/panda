...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RelatedUpload.size'
        db.alter_column('panda_relatedupload', 'size', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'Export.size'
        db.alter_column('panda_export', 'size', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'DataUpload.size'
        db.alter_column('panda_dataupload', 'size', self.gf('django.db.models.fields.BigIntegerField')())
    def backwards(self, orm):

        # Changing field 'RelatedUpload.size'
        db.alter_column('panda_relatedupload', 'size', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Export.size'
        db.alter_column('panda_export', 'size', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'DataUpload.size'
        db.alter_column('panda_dataupload', 'size', self.gf('django.db.models.fields.IntegerField')())
    models = {
        'auth.group': {
