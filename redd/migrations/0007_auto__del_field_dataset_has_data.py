...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Dataset.has_data'
        db.delete_column('redd_dataset', 'has_data')


    def backwards(self, orm):
        
        # Adding field 'Dataset.has_data'
        db.add_column('redd_dataset', 'has_data', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
