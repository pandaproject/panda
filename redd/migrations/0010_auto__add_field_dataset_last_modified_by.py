...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dataset.last_modified_by'
        db.add_column('redd_dataset', 'last_modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Dataset.last_modified_by'
        db.delete_column('redd_dataset', 'last_modified_by_id')
