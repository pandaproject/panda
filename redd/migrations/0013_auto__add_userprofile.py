...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'redd.upload': {
            ...
            'dataset': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'uploads'", 'to': "orm['redd.Dataset']"}),
