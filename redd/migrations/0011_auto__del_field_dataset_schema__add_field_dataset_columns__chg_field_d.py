...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Dataset.schema'
        db.delete_column('redd_dataset', 'schema')

        # Adding field 'Dataset.columns'
        db.add_column('redd_dataset', 'columns', self.gf('redd.fields.JSONField')(default=None, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Dataset.schema'
        db.add_column('redd_dataset', 'schema', self.gf('redd.fields.JSONField')(default=None, null=True), keep_default=False)

        # Deleting field 'Dataset.columns'
        db.delete_column('redd_dataset', 'columns')

        # Changing field 'Dataset.creation_date'
        db.alter_column('redd_dataset', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=None))
