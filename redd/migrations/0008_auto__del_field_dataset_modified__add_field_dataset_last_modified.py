...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('redd_dataset', 'modified')

        # Adding field 'Dataset.last_modified'
        db.add_column('redd_dataset', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Dataset.modified'
        db.add_column('redd_dataset', 'modified', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Dataset.last_modified'
        db.delete_column('redd_dataset', 'last_modified')
