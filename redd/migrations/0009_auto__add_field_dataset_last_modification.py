...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dataset.last_modification'
        db.add_column('redd_dataset', 'last_modification', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Dataset.last_modification'
        db.delete_column('redd_dataset', 'last_modification')
