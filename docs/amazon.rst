...
Once your new server is available, SSH into it and execute the following commands::
    ...
    wget https://raw.github.com/pandaproject/panda/0.1.5/setup_panda.sh
