...
It depends on how powerful of a server you need, but for an EC2 "t2.small", 500 GB of magnetic storage and bandwidth it will cost you about $45 a month ($540 a year). However, if you prepay for 1 year all-upfront reserved instance, this cost comes down under to $300 a year. The "small" size is our default and probably enough for many small-to-medium size organizations. See Amazon's `EC2 pricing page <http://aws.amazon.com/ec2/pricing/>` for more details.

Very small organizations can also try running PANDA on an EC2 "micro", at a cost of approximately $15 per month ($!80 per year month-to-month, or $120 a year for a prepaid reserved instance), however, this is infrequently tested and not likely to perform well for more than a handful of users.
